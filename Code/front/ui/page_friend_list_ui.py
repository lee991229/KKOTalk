...
class Ui_friend_list_widget(object):
    ...
    def retranslateUi(self, friend_list_widget):
        ...
        self.pushButton.setText(_translate("friend_list_widget", "x"))
        self.label_6.setText(_translate("friend_list_widget", "친구,채팅"))
        self.pushButton_7.setText(_translate("friend_list_widget", "PushButton"))
        self.pushButton_8.setText(_translate("friend_list_widget", "PushButton"))
        self.pushButton_10.setText(_translate("friend_list_widget", "PushButton"))
        self.pushButton_11.setText(_translate("friend_list_widget", "PushButton"))
        self.label_8.setText(_translate("friend_list_widget", "이름"))
