...
class Ui_takl_room_member_plus_widget(object):
    def setupUi(self, takl_room_member_plus_widget):
        ...
        takl_room_member_plus_widget.resize(400, 400)
        ...
        self.frame = QtWidgets.QFrame(takl_room_member_plus_widget)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 396, 267))
    ...
    def retranslateUi(self, takl_room_member_plus_widget):
        ...
        self.pushButton.setText(_translate("takl_room_member_plus_widget", "x"))
