...
class Ui_ui_friend_list_widget(object):
    def setupUi(self, ui_friend_list_widget):
        ui_friend_list_widget.setObjectName("ui_friend_list_widget")
        ui_friend_list_widget.resize(600, 850)
        self.verticalLayout = QtWidgets.QVBoxLayout(ui_friend_list_widget)
        self.verticalLayout.setObjectName("verticalLayout")
        self.frame_3 = QtWidgets.QFrame(ui_friend_list_widget)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 417, 547))
        ...
        self.retranslateUi(ui_friend_list_widget)
        QtCore.QMetaObject.connectSlotsByName(ui_friend_list_widget)

    def retranslateUi(self, ui_friend_list_widget):
        _translate = QtCore.QCoreApplication.translate
        ui_friend_list_widget.setWindowTitle(_translate("ui_friend_list_widget", "Form"))
        self.label.setText(_translate("ui_friend_list_widget", "크크오톡,채팅방 이름"))
        self.pushButton.setText(_translate("ui_friend_list_widget", "x"))
        self.label_6.setText(_translate("ui_friend_list_widget", "친구,채팅"))
        self.pushButton_7.setText(_translate("ui_friend_list_widget", "PushButton"))
        self.pushButton_8.setText(_translate("ui_friend_list_widget", "PushButton"))
        self.pushButton_10.setText(_translate("ui_friend_list_widget", "PushButton"))
        self.pushButton_11.setText(_translate("ui_friend_list_widget", "PushButton"))
        self.label_8.setText(_translate("ui_friend_list_widget", "이름"))
        self.label_2.setText(_translate("ui_friend_list_widget", "TextLabel"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ui_friend_list_widget = QtWidgets.QWidget()
    ui = Ui_ui_friend_list_widget()
    ui.setupUi(ui_friend_list_widget)
    ui_friend_list_widget.show()
    sys.exit(app.exec_())
